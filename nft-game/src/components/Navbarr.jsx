...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex flex-row justify-between items-center px-3 sm:px-4 py-3 border-b-2 border-b-yellow-500'>
      ...
      <ul
        className={`flex absolute py-4 pr-3 sm:pr-0 sm:static sm:w-fit items-center top-16 w-full right-0 h-fit sm:h-fit bg-gray-950  flex-col sm:flex-row gap-6 sm:gap-8 md:gap-10 text-sm sm:text-lg sm:items-center ${
