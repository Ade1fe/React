...
<Box w={['100%', '100%', '50%']}>
            ...
            <Button className="" >Cardless Withdrawal</Button>
        </Box>
      <Image w={['100%', '100%', '50%']} onClick={goToNextPage} cursor='pointer' src={cardimg} />
</Box>
<Text mt={['4rem', '5rem',  '7rem', "10rem"]} fontSize={["sm", 'md',]} className="subtitles "cursor='pointer' onClick={goToNextPage}><Icon as={MdOutlineTouchApp} boxSize={8} /> For your convenience, this ATM features a touch screen interface. Simply follow the instructions on the screen and tap pn the card to continue.</Text>
    </Box>
  )
}
