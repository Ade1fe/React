  ...
  const handleWithdrawal = async () => {
    ...
    try {
      ...
      await setDoc(userDocRef, { 
        ...
        userId: currentUser.uid // Adding userId to the document data
      }, { merge: true });
    ...
    <LayoutComp desc='Enter the amount you want to withdraw'>
      <Box display={['block', 'block', 'flex']} >
        ...
        <Box className="" w={['full', 'full', '65%']} pos='relative'>
          <Buttons imageText={atmcardimg} title="Enter amount to withdraw" placeholder="1.000" inputId="amount" onDigitClick={handleDigitClick} onDeleteClick={handleDeleteClick} value={amount} onWithdrawClick={handleWithdrawal} buttonText='Withdraw' />
