...
//   const [currentUser, setCurrentUser] = useState<User | null>(null); // Corrected type definition
...
//           size='xl'/>
//         ) : currentUser ? (
//           <TableContainer overflowY="auto" maxHeight="calc(100vh - 200px)">
//             <Table minWidth="100%" >
//               <Thead>
//                 <Tr fontSize={['xs']}>
...
//                   <Th fontSize={['xs']}>Date</Th>
//                   <Th fontSize={['xs']}>Account Number</Th>
//                   <Th fontSize={['xs']}>Recieve Money</Th>
//                   <Th fontSize={['xs']}>Withdraw</Th>
//                   <Th fontSize={['xs']}>Deposit</Th>
//                   <Th fontSize={['xs']}>Send Money</Th>
//                   <Th fontSize={['xs']}>Bank Name</Th>
...
//       <Td>{transaction.timestamp}</Td>
//       <Td>{transaction.accountNumber}</Td>
//       <Td>{transaction.type === 'receive-money' ? transaction.amount : '-'}</Td>
//       <Td>{transaction.bankReceiverAccountNumber === currentUser?.uid || transaction.type === 'receive-money' ? transaction.amount : '-'}</Td>
//       <Td>{transaction.type === 'withdrawal' ? transaction.amount : '-'}</Td>
//       <Td>{transaction.type === 'deposit' ? transaction.amount : '-'}</Td>
//       <Td>{transaction.type === 'send-money' ? transaction.amount : '-'}</Td>
//       <Td>{transaction.selectedBank !== '-' ? transaction.selectedBank : transaction.bankName}</Td>
...
const BankStatements: React.FC = () => {
  ...
  {transactions.map((transaction, index) => (
    <Tr key={index}>
      <Td>{transaction.timestamp}</Td>
      <Td>{transaction.accountNumber}</Td>
      <Td>{(transaction.accountNumber === currentUser?.uid && transaction.type !== 'receive-money') ? transaction.amount : '-'}</Td>
      <Td>{transaction.type === 'withdrawal' ? transaction.amount : '-'}</Td>
      <Td>{transaction.type === 'deposit' ? transaction.amount : '-'}</Td>
      <Td>{transaction.type === 'send-money' ? transaction.amount : '-'}</Td>
      <Td>{transaction.selectedBank !== '-' ? transaction.selectedBank : transaction.bankName}</Td>
