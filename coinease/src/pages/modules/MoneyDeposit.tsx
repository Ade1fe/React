...
//     if (isNaN(moneyToDeposit)) return; 
...
//           <Buttons imageText={atmcardimg} title="Enter amount to deposit" placeholder="1.000" inputId="amount" onDigitClick={handleDigitClick} onDeleteClick={handleDeleteClick} />
//           {isLoading && 'Loading...'} 
//           {moneyToDeposit !== null && `You have successfully deposited $${moneyToDeposit}`}
