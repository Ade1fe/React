...
const MainContainer = () => {
  return (
    <div className="relative">
     <div className="w-full h-auto md:h-[450px] lg:h-[500px]">
     <img src={contain} className='w-full h-full  object-cover' alt="Tasty Food" />
     </div>
      ...
      <div className="absolute w-[90%] sm:w-auto top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center">
        <h2 className="text-4xl font-bold">Tasty Food</h2>
        <p className="mt-4">
