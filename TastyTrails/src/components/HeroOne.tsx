  ...
  return (
    <Box className='text-fonts'   fontFamily='300' my={['20px']} display={['block', 'block', 'block', 'flex']} justifyContent='space-between' maxWidth='1340px' mx='auto' gap={['20px']} mt={['3rem']}>
      <Box w={["full", 'full', 'full', "470px"]} mb={['2rem', '3rem', '4rem', '0']}>
        ...
        <Text fontSize={["md", "lg",]}>Sick of waiting for deliveries? Our lightning-fast service is your solution. Say goodbye to long waits and hello to doorstep deliveries. From groceries to packages, we've got you covered. Try our efficient service today!</Text>
