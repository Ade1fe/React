...
import { Box, Text, Link as ChakraLink, Icon } from '@chakra-ui/react';
...
const Navbar: React.FC<NavbarProps> = ({ isAuthenticated }) => {
  ...
  return (
    <Box className='subtitle' maxWidth='1340px' mx='auto' display={['flex', 'flex']} justifyContent={[ 'space-between']} gap='4' py='4' alignItems='center'>
      <Box className="">
      ...
      <Box px='20px' bg='white' shadow='sm' py='10px' justifyContent='space-between' gap='4' fontSize={['md', 'lg']}>
        {isAuthenticated ? (
