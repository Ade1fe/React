...
//          <>
//           <Box className="">
//           <Text noOfLines={1} display={['block', 'block', 'none']}  textTransform='capitalize'>{loading ? 'Loading...' : (userName ? `Welcome ${userName}` : 'Welcome, no name')}</Text>
//    <Box display={['none', 'none', 'block']} className="">
//    <Menu>
//   <MenuButton as={Button} rightIcon={<FaArrowDown />}>
//   <Text noOfLines={1} textTransform='capitalize'>{loading ? 'Loading...' : (userName ? `Welcome ${userName}` : 'Welcome, no name')}</Text>
//   </MenuButton>
//   <MenuList>
//   <ChakraLink as={ReactRouterLink} to='/settings'>   <MenuItem display='flex' alignItems='center' gap='3'> 
//         <Icon as={AiFillSetting} boxSize={['5', '6', '6']} />
//     Settings</MenuItem>  </ChakraLink>
...
//       <ChakraLink as={ReactRouterLink} to='/settings'>  <Icon as={AiFillSetting} boxSize={['5', '6', '6']} /> </ChakraLink>
//     </Tooltip>
//     ) : (
//       <Box pr={[6,7,8,10]}>
        
//         <Tooltip label="Sign Out">
//      <ChakraLink as={ReactRouterLink} to='/sign-up'><Icon as={FiLogIn} boxSize={['5', '6', '6']} /></ChakraLink> 
//      </Tooltip>
