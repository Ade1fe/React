...
//     <Box display={["block", 'flex', 'block', 'flex']} borderTopWidth='1px' px='10px' borderTopColor='#f1f1f1' borderBottomWidth='1px' borderBottomColor='#f1f1f1'  py='20px' textAlign={['center','left', 'center','left']} alignItems="center" cursor='pointer' >
...
//         </Button>
//       </Box>
//       <Button mt={['10px', '0','10px','0']} px='15px' rounded='lg' py='5px' borderColor='orange.500' borderWidth='2px' textAlign={['center']} mx='auto'>Add</Button>
//     </Box>
...
const AllFood: React.FC<AllFoodProps> = ({ id, imageUrl, name }) => {
  const [quantity, setQuantity] = useState<number>(0);
