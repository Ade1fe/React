...
const Footer = () => {
  return (
    <div className='grid text-xs  md:text-sm justify-center text-center p-3 sm:py-3 text-white bg-purple-600  mt-[50px] sm:px-8 items-center sm:flex sm:justify-between'>
