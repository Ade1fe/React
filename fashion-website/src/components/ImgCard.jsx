  ...
  return (
    <div className=' h-max w-max hover:shadow-md'>
       ...
       <div className="pt-1 pb-3 px-3 text-center">
        <h1 className='font-semibold sm:font-bold mb-1 capitalize text-xl '>{h1}</h1>
        <p className='text-cyan-400 mb-1'>{price}</p>
        <button className='border-b-2 border-gray-100 text-sm  hover:text-cyan-300'>ADD TO CART</button>
       </div>
