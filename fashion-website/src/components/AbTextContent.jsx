...
const AbTextContent = () => {
  return (
    <div className="grid lg:flex px-4 gap-2 md:gap-5 md:px-8 mt-[40px]">
      ...
      <p>Hymenaeos quod luctus placeat, fugiat, voluptatem temporibus nesciunt? Est laoreet, incidunt debitis cum dolorem neque iure, voluptates ornare rerum quis, laboriosam, quia corporis repudiandae, iste debitis lacus mauris ab.</p>
        <div className="flex flex-wrap gap-4 mt-[30px] justify-center items-center">
