...
const TopMusicCard: React.FC<TopMusicCardProps> = ({ imageUrl, musicName, duration }) => {
  return (
    <Box bg='#111' textAlign='left' display='flex' px='6' py='2' borderRadius='lg' justifyContent='space-between' gap='4' alignItems='center'>
        <Image boxSize={[10,12,14]} src={imageUrl} borderRadius='50%' border='2px' borderColor='purple.800' /> 
