...
<div className="w-[90%] mx-auto md:w-1/3  my-3 md:my-0 rounded-[20px]">
      ...
      />
            ...
            <div className="px-4 flex justify-center items-start rounded-[20px] flex-col w-[90%] mx-auto h-[200px] md:h-auto md:w-2/3  my-3 md:my-0"style={{ boxShadow: 'rgba(17, 17, 26, 0.05) 0px 1px 0px, rgba(17, 17, 26, 0.1) 0px 0px 8px' }}>

<h1 className='text-xl sm:text-2xl'>Let's</h1>
<h1 className='pb-5 md:pb-0 text-xl sm:text-2xl'>Work <span className='text-[#DEAAFF]'>Together</span></h1>
</div>
