...
const AnimeOnaSearchBar = ({ getValue }) => {
  ...
  const handleAnimeDataChange = (data) => {
    ...
    const tvAnimeList = data.filter((anime) => anime.type.toLowerCase() === 'ona');
  ...
  return (
    <div>
      ...
      <AnimeFetcher
        endpoint={`https://api.jikan.moe/v4/anime?q=${getValue}&limit=25&type=ona`}
...
export default AnimeOnaSearchBar
