...
const AnimeSpecialSearchBar = ({ getValue }) => {
  ...
  const handleAnimeDataChange = (data) => {
    ...
    const tvAnimeList = data.filter((anime) => anime.type.toLowerCase() === 'special');
  ...
  return (
    <div>
      ...
      <AnimeFetcher
        endpoint={`https://api.jikan.moe/v4/anime?q=${getValue}&limit=25&type=special`}
...
export default AnimeSpecialSearchBar
