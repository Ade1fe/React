...
const TvAnimeSearchBar = ({ getValue }) => {
  ...
  return (
    <div>
      {/* Fetch data for new added TV anime */}
      <AnimeFetcher
        endpoint={`https://api.jikan.moe/v4/anime?q=${getValue}&limit=25&type=TV`}
...
export default TvAnimeSearchBar;
