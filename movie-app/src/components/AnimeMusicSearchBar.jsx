...
const AnimeMusicSearchBar = ({ getValue }) => {
  ...
  const handleAnimeDataChange = (data) => {
    ...
    const tvAnimeList = data.filter((anime) => anime.type.toLowerCase() === 'music');
  ...
  return (
    <div>
      ...
      <AnimeFetcher
        endpoint={`https://api.jikan.moe/v4/anime?q=${getValue}&limit=25&type=music`}
...
export default AnimeMusicSearchBar
