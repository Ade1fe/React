...
const fetchFiles = async () => {
  ...
  if (userId) {
    const filesCollection = collection(firestore, "writeFiles");
  ...
  const updateFileInFirestore = async (file: FileItem): Promise<void> => {
    const fileDocRef = doc(firestore, "writeFiles", file.id!);
...
const handleDelete = async (index: number) => {
  ...
  const fileDoc = doc(firestore, "writeFiles", files[index].id!);
