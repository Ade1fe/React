...
const fetchFiles = async () => {
  ...
  if (userId) {
    const filesCollection = collection(firestore, "businessFiles");
  ...
  const updateFileInFirestore = async (file: FileItem): Promise<void> => {
    const fileDocRef = doc(firestore, "businessFiles", file.id!);
...
const handleDelete = async (index: number) => {
  ...
  const fileDoc = doc(firestore, "businessFiles", files[index].id!);
