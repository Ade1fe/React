...
const fetchFiles = async () => {
  ...
  if (userId) {
    const filesCollection = collection(firestore, "workFiles");
  ...
  const updateFileInFirestore = async (file: FileItem): Promise<void> => {
    const fileDocRef = doc(firestore, "workFiles", file.id!);
...
const handleDelete = async (index: number) => {
  ...
  const fileDoc = doc(firestore, "workFiles", files[index].id!);
