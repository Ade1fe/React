...
const fetchFiles = async () => {
  ...
  if (userId) {
    const filesCollection = collection(firestore, "plansFiles");
  ...
  const updateFileInFirestore = async (file: FileItem): Promise<void> => {
    const fileDocRef = doc(firestore, "plansFiles", file.id!);
...
const handleDelete = async (index: number) => {
  ...
  const fileDoc = doc(firestore, "plansFiles", files[index].id!);
