...
const fetchFiles = async () => {
  ...
  if (userId) {
    const filesCollection = collection(firestore, "tasksFiles");
  ...
  const updateFileInFirestore = async (file: FileItem): Promise<void> => {
    const fileDocRef = doc(firestore, "tasksFiles", file.id!);
...
const handleDelete = async (index: number) => {
  ...
  const fileDoc = doc(firestore, "tasksFiles", files[index].id!);
