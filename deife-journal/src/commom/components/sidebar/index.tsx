...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const handleItemClick = (itemId: string | null) => {
    if (itemId === "logout" && activeItem === "logout") {
      return; // Return early if "Logout" is already the active item
    }
    ...
    <>
      ...
      >
        ...
        <Text
            ...
            position="absolute"
            bottom="-0vh" // Adjust this value as needed
          >
            <Text as="span" color="#023E8A">
              <FiLogOut size={25} />
            </Text>{" "}
          ...
          {/* End of styling for the Logout item */}
      </Box>
      {isMobile && isSidebarOpen && (
        <Box
          bg="rgba(0, 0, 0, 0.5)"
