...
const PopularItems = () => {
  ...
  return (
    <div className="container mx-auto text-center  sm:px-3 md:px-4">
        ...
        <p className='text-sm md:text-lg w-[full] md:w-[80%] mx-auto font-semibold text-center px-4 mb-6 md:mb-14'>At our establishment, we understand that time is of the essence, and our top priority is to provide you with a culinary journey that's not only mouthwatering but also swift.</p>
