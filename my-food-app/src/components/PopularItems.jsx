...
const PopularItems = () => {
  ...
  return (
    <div className="container mx-auto text-center  sm:px-3 md:px-4">
        ...
        <p className='text-lg w-[full] md:w-[80%] mx-auto font-semibold text-center px-4 mb-6 md:mb-14'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi fuga esse laudantium
    ...
    <button className='w-fit px-4 py-2 mx-auto text-center mt-5 md:mt-10 bg-orange-500 text-lg rounded-md
