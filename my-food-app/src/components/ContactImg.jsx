  ...
  return (
   <div className="">
    ...
    <div className="bg-transparent border-2 w-fit rounded-[50%] border-orange-500 text-orange-500 p-2  hover:text-black cursor-pointer">
          ...
          <h2 className='text-sm font-semibold'>+2349038257434</h2>
    </div>
        <div className="flex gap-4 mb-3">
        <div className="bg-transparent border-2 w-fit rounded-[50%] border-orange-500 text-orange-500 p-2  hover:text-black cursor-pointer">
        <FaEnvelope size={18} />
        </div>
        <h2 className='text-sm font-semibold whitespace-normal'>addypearl09@gmail.com</h2>
        </div>
        <div className="flex gap-4 mb-3 items-center">
        <div className="bg-transparent border-2 w-fit rounded-[50%] border-orange-500 text-orange-500 p-2  hover:text-black cursor-pointer">
            <FaSearchLocation size={18} />
        </div>
        <h2 className='text-sm font-semibold'>04, Bode Edun Ogun state, Nigeria</h2>
        </div>
    </div>
   </div>
  )
