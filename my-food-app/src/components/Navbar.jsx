  ...
  return (
    <header className='flex  justify-between items-center px-2 sm:px-5 py-3 md:px-10 bg-white border-b-2 border-b-orange-500 '>
      ...
      {/* <div className="flex items-center"> */}
        ...
        absolute top-[63.5px] right-0 bg-white border-l-2 border-l-orange-500 border-b-2 border-b-orange-500 md:border-none  w-[50%] px-8 py-4 text-center          
          md:static md:w-fit  md:p-0 md:bg-white
        ${isMenuOpen ? 'block' : 'hidden'}`}>
          <li className='hover:bg-gray-100 cursor-pointer hover:px-2 hover:py-1 rounded-md hover:shadow-md w-fit mx-auto mb-5 md:m-0'>Menu</li>
          ...
          <li className='hover:bg-gray-100 cursor-pointer hover:px-2 hover:py-1 rounded-md hover:shadow-md w-fit mx-auto mb-5 md:m-0'>Contact</li>
        ...
        <ul className='flex text-lg justify-between items-center font-semibold gap-4 sm:gap-7 md:gap-10 lg:gap-14 order-1 md:order-2'>
          ...
          <li className='whitespace-nowrap bg-orange-500 text-white border-2 border-orange-500 cursor-pointer px-3 py-1 rounded-md shadow-lg hover:bg-transparent hover:text-black'>Sign in</li>
        </ul>
      {/* </div> */}
    </header>
  );
